...
<head>
  ...
  <title>Edit News | Immonology Congress</title>
        ...
        <div class="col-md-6">
          <!-- general form elements -->
              <div class="box-body">
				...
				<input type="hidden" value="<?php echo $news['image_url'];   ?>" name="url" />
					<input type="hidden" value="<?php echo $news['id'];   ?>" name="id" />
                     <div class="">
                     <img src="<?php echo $news['image_url'];   ?>" class="img img-thumbnail" width="50px;"><br/>
				...
				<div class="form-group">
                  ...
                  <textarea class="form-control" name="content" required><?php echo $news['news'];   ?></textarea>
                </div>
