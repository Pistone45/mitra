...
<head>
  ...
  <title>Dashboard | Office World</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="index.php">View Products</a></li>
			...
			<th>Product Category</th>
			 <?php
						if(isset($products) && count($products)>0){
							...
							<tr>
								<td><img src="<?php echo $product['image']; ?>" height="70px" width="70px;" /></td>
								<td><?php echo $product['name']; ?></td>
								<td><?php echo $product['category']; ?></td>
								<td><a href="#"><i class="fa fa-pencil"></i> Edit/Delete</a></td>
							</tr>
							<?php
							}
