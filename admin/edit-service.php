...
if(isset($_POST['submit'])){
	...
	//validate  file
	 ...
	 $editService->editService($bannerpath,$title,$content,$service_id);
          ...
          <!-- general form elements -->
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input class="form-control" name="title" value="<?php echo $service['title'];   ?>" required>
                </div>
				...
				<div class="form-group">
                  ...
                  <textarea class="form-control" name="content" required><?php echo $service['content'];   ?></textarea>
                </div>
