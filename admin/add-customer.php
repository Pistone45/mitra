  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="add-customer.php">Customer Registration</a></li>
          ...
          <div class="box box-primary">
			...
			<?php
                            if(isset($_SESSION["customer-added"]) && $_SESSION["customer-added"]==true)
                            {
                                ...
                                echo "<strong>Success! </strong>"; echo "You have successfully added a Customerr";
                                unset($_SESSION["customer-added"]);
                                echo "</div>";
								 header('Refresh: 5; URL= add-customer.php');
                            }
							?>
              <div class="box-body">
