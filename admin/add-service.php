  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="add-service.php">Add Sevice</a></li>
	...
	<!-- form start -->
            <form role="form" action="add-service.php" method="POST" enctype="multipart/form-data">
			<?php
                            if(isset($_SESSION["service-added"]) && $_SESSION["service-added"]==true)
                            {
                                echo "<div class='alert alert-success'>";
                                echo "<button type='button' class='close' data-dismiss='alert'>*</button>";
                                echo "<strong>Success! </strong>"; echo "You have successfully added news";
                                unset($_SESSION["service-added"]);
                                echo "</div>";
