...
if(isset($_POST['zone'])){
	...
	$logtable = $getLogTable->getLogTable($id);
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="get-log-table.php">Log Table</a></li>
      ...
      <div class="row box box-primary">
        ...
        <div class="col-md-12">
           ...
           <div class="box-header">
              <h3 class="box-title"><b><?php if(isset($zone) && count($zone)>0){ echo $zone['name'];}?></b></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
